...
Во второй части, в <b>A/B-тесте</b>, мы протестировали новый алгоритм рекомендаций для ленты, цель которого — повысить кликабельность (<b>CTR</b>). Для анализа использовался набор методик: как классические статистические тесты Стюдента и Манна-Уитни, так и Сглаживание, Poisson Bootrstrap, Bucket Transformation и Linearization. 
